    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content bg-dark text-white">
            ...
            <div class="modal-body">
                <form action="<?php echo BASE_URL . 'controller/productos/crearProducto.php' ?>" method="POST" enctype="multipart/form-data">
                <!-- Imagen -->
                <div class="mb-3">
                    <label class="form-label fw-semibold" for="imagen">
                        <i class="fas fa-image me-1 text-info"></i> Imagen
                    </label>
                    <input class="form-control bg-dark text-white border-secondary" type="file" name="imagen"
                        id="imagen" accept="image/*" required>
                </div>
                <div class="mb-3">
